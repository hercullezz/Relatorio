...
public class MachineDao_Impl(
  ...
  private val __updateAdapterOfMachine: EntityDeleteOrUpdateAdapter<Machine>
  init {
    this.__db = __db
    ...
    this.__updateAdapterOfMachine = object : EntityDeleteOrUpdateAdapter<Machine>() {
      protected override fun createQuery(): String = "UPDATE OR ABORT `machines` SET `id` = ?,`name` = ?,`lineId` = ? WHERE `id` = ?"
  ...
  public override suspend fun updateMachine(machine: Machine): Unit = performSuspending(__db, false, true) { _connection ->
    __updateAdapterOfMachine.handle(_connection, machine)
  }
