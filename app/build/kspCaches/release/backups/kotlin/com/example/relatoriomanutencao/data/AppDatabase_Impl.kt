...
public class AppDatabase_Impl : AppDatabase() {
  ...
  protected override fun createOpenDelegate(): RoomOpenDelegate {
    val _openDelegate: RoomOpenDelegate = object : RoomOpenDelegate(2, "a7d2d4d09ac04526b2d24e90029d6d42", "5c0929ac1ed71bc56cad2f38950b6499") {
      public override fun createAllTables(connection: SQLiteConnection) {
        connection.execSQL("CREATE TABLE IF NOT EXISTS `maintenance_items` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `machine` TEXT NOT NULL, `serviceType` TEXT NOT NULL, `description` TEXT NOT NULL, `date` INTEGER NOT NULL, `photoUris` TEXT NOT NULL)")
        ...
        connection.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'a7d2d4d09ac04526b2d24e90029d6d42')")
      }
